...
/**
 * Role Selection Page
 * Users select whether they are a Couple (Customer) or Vendor (Planner)
 */
session_start();
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="role-card planner-card">
                    ...
                    <h2 class="role-title">I'm a Vendor</h2>
                    <p class="role-description">
                    ...
                    <ul class="role-features">
                        ...
                        <li><i class="bi bi-check-circle-fill"></i> Build your portfolio</li>
                            ...
                            Continue as Vendor <i class="bi bi-arrow-right ms-2"></i>
                        </a>
                </div>
            </div>
        </div>
